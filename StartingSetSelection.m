function [combs, f_l, time_l, it_cost_l, n_it_l] = StartingSetSelection(N, x_l, x_u, eps, C, e, beta)
        ...
        for k = 1:length(perc_u)
            if (perc_l(j) + perc_u(k) <= 0.5)
                ...
                for n = 1:n_attemps
                    ...
                    [f_e_k, time_t_k, it_cost_k, n_it_k] = svr.ActiveSet(round(N*10000), false, false);
