function [f_l, time_l, it_cost_l, n_it_l] = Scalability(x_l, x_u, eps, C, e, beta, perc_l, perc_u)
    ...
    for i = 1:length(N_l)
        ...
        n_it_std = 0;
        for k = 1:n_attemps
            svr = SVR(x, y, C, e, beta, "perc", perc_l, perc_u);
            [f_e_k, time_t_k, it_cost_k, n_it_k] = svr.ActiveSet(round(N_l(i)*1000), false, false);
            ...
            fprintf("Computational cost: %f; n. iterations: %d\n", time_t_k, n_it_k);
        end
